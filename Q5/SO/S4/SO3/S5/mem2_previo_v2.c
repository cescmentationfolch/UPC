...
//int vector[40960]; //desdefillvector no se puede usar vector normal porque no ha sido definido antes de crear esta función por eso lo utiliza como puntero
